...
if vbpca
  ...
  %print('-depsc', '/home/jluttine/papers/2009NIPS/poster/fig_artificial_vbpca_latent');
...
%set(gcf, 'Color','none');
%set(hax, 'Color', 'none');
%export_fig('/home/jluttine/papers/2009NIPS/poster/fig_artificial_latent', ...
%           '-eps');
...
%xlabel('time, t');
set_figure_size(5, 5);
set_label_fontsize(hax, 4);
%set(gcf, 'Color','none');
%set(hax, 'Color', 'none');
%export_fig('/home/jluttine/papers/2009NIPS/poster/fig_artificial_predictive', ...
%           '-eps');
...
set_figure_size(12, 4, fig1);
set_figure_size(12, 4, fig2);
set_figure_size(12, 4, fig3);
%print(fig1, '-depsc', '/home/jluttine/papers/2009NIPS/poster/fig_artificial_loadings');
