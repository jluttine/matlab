...
examples = [19 1 20 5 23  28];%random([4 9 14 15]);
...
if vbpca
  ...
  for i=1:length(hax)
    ...
    lab = sprintf('s_{%d}(t)', i);
    ylabel(lab);
  end
  xlabel('time, t');
  set_figure_size(gcf, 12, 7);
  set_label_fontsize(hax, 6);
  print('-depsc2', '/home/jluttine/thesis/figures/fig_artificial_vbpca_latent');
  ...
  set_label_fontsize(hax, 6);
  print('-depsc2', ['/home/jluttine/thesis/figures/' ...
...
set_label_fontsize(hax, 6);
print('-depsc2', '/home/jluttine/thesis/figures/fig_artificial_latent');
...
set_figure_size(gcf, 7, 6);
set_label_fontsize(hax, 6);
print('-depsc2', '/home/jluttine/thesis/figures/fig_artificial_true_latent');
...
xlabel('time, t');
set_figure_size(gcf, 13, 16);
set_label_fontsize(hax, 6);
print('-depsc2', '/home/jluttine/thesis/figures/fig_artificial_predictive');
...
for i=1:3
  set_subplot_positions(hax(:,i), 1, 4, [0.01 0.01 0.01 (cb_height+ ...
...
set_figure_size(fig1, 13, 3.8);
set_figure_size(fig2, 13, 3.8);
set_figure_size(fig3, 13, 3.8);
print(fig1, '-depsc2', '/home/jluttine/thesis/figures/fig_artificial_loadings');
print(fig2, '-depsc2', ['/home/jluttine/thesis/figures/' ...
                    'fig_artificial_loadings_uncertainty']);
print(fig3, '-depsc2', ['/home/jluttine/thesis/figures/' ...
                    'fig_artificial_true_loadings']);
