...
% $$$   print(mapfigh, '-depsc2', ['/home/jluttine/papers/2009NIPS/poster/' ...
% $$$                     'fig_experiment_loadings_gppca.eps']);
% $$$   print(tsfigh, '-depsc2', ['/home/jluttine/papers/2009NIPS/poster/' ...
...
if true
  ...
  filename = sprintf(['/home/jluttine/papers/2009NIPS/poster/' ...
...
% $$$     set(h_cb, 'Position', cb_pos);
  ...
  set(hax, 'Color', 'none');
  set(gcf, 'Color', 'none');
  set_subplot_positions(hax, 1,4, [0.01 0.01 0.01 0.2], [0.01 0.1]);
  set_colorbar_position(h_cb, hax, 0.06, 0.01);
  set(h_cb, 'FontSize', 5);
  set_figure_size(gcf, 12, 2);
  filename = sprintf(['/home/jluttine/papers/2009NIPS/poster/' ...
...
% $$$ 
  ...
  if strcmpi(method, 'gppca')
    ...
    set(gcf, 'Position', [pos(1) pos(2) figw figh]);
    set(gcf, 'PaperPositionMode', 'auto', 'PaperSize', [figw figh]);
    filename = '/home/jluttine/papers/2009NIPS/poster/eyecatcher.eps';
    %print(gcf, '-depsc2', filename);
    export_fig(filename, '-eps');
  end
