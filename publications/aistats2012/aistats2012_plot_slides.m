function aistats2012_plot_slides()
...
% $$$ print('-dpdf', '/home/jluttine/papers/aistats2012/slides/fig_artificial_f');
...
hl = legend({'marginal (effective)', 'marginal (single)', ...
             'Gibbs (effective)',  'Gibbs (single)'}, ...
...
decades_equal(gca);
%set(gca, 'Box', 'off' );
set_figure_size(12,10)
print('-dpdf', '/home/jluttine/papers/aistats2012/slides/fig_artificial_theta');
