function nips2011_comparison(D, s, sample_hyperparameters, kronecker, fid)

fid = fopen('/home/jluttine/matlab/publications/nips2011/res.txt', 'a');
...
folder = '/home/jluttine/matlab/publications/nips2011/results';
filename = sprintf('%s/results_nips2011_comparison_D=%g_kron=%d_s=%g_date=%s', ...
...
% $$$   plot(res1.F(:,n2), 'g');
  ...
  print('-depsc2', '/home/jluttine/papers/gpkron/fig_artificial_comparison');
  return
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
