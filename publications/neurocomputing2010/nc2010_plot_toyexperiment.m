function figh = nc2010_plot_toyexperiment(n,m,d,ncomps,flatW,datatype,varargin)
%
...
filename = sprintf(['/home/jluttine/matlab/neurocomputing2010/' ...
                    'nc2010_%s_toyexperiment_%s_subspace=%s_n=%d_m=%d_d=%d_ncomps=%d'], ...
                   model,stringW,datatype,n,m,d,ncomps); 
